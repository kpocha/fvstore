...
/*  86 */       color = new Color((Device)display, rgb);
...
/* 121 */         return new Image((Device)display, data, data.getTransparencyMask());
/*     */       }
/* 123 */       return new Image((Device)display, data);
/*     */     } finally {
/* 125 */       stream.close();
/*     */     } 
/*     */   }
...
/* 176 */     Image image = new Image((Device)Display.getCurrent(), 10, 10);
/*     */     
/* 178 */     GC gc = new GC((Drawable)image);
...
/*     */ 
/*     */   
/* 209 */   private static Map<Image, Map<Image, Image>>[] m_decoratedImageMap = (Map<Image, Map<Image, Image>>[])new Map[5];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 253 */       result = new Image((Device)Display.getCurrent(), bib.width, bib.height);
/*     */       
/* 255 */       GC gc = new GC((Drawable)result);
...
/*     */         } 
/*     */       }
/* 361 */       font = new Font((Device)Display.getCurrent(), fontData);
...
/* 378 */       font = new Font((Device)Display.getCurrent(), data.getName(), data.getHeight(), 1);
...
/* 417 */     if (cursor == null) {
/* 418 */       cursor = new Cursor((Device)Display.getDefault(), id);
...
/* Location:              C:\facilvirtual\facilvirtual\!\org\eclipse\wb\swt\SWTResourceManager.class
