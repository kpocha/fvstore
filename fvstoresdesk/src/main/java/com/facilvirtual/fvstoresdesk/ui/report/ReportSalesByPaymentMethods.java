...
public class ReportSalesByPaymentMethods extends AbstractFVDialog {
   ...
   public ReportSalesByPaymentMethods(Shell parentShell) {
      super(parentShell);
   }
   ...
   @Override protected void configureShell(Shell newShell) {
      ...
      this.initTitle(newShell, "Informe de Ventas por medios de pago");
   }
