...
public class AddNewCashOutflow extends AbstractFVDialog {
   private static Logger logger = LoggerFactory.getLogger("AddNewCashOutflow");
   private String action = "";
   private Text txtDescription;
   private Text txtAmount;
   private Employee employee;

   public AddNewCashOutflow(Shell parentShell) {
      super(parentShell);
   }
   ...
   protected Control createDialogArea(Composite parent) {
      ...
      lblTitle.setText("Nuevo egreso de caja");
   ...
   private void processDialog() {
      if (this.validateFields()) {
         try {
            ...
            this.getAppConfigService().decCashAmount(this.getWorkstationConfig(), cashOperation.getAmount());
   ...
   @Override protected void configureShell(Shell newShell) {
      ...
      this.initTitle(newShell, "Nuevo egreso de caja");
   }
