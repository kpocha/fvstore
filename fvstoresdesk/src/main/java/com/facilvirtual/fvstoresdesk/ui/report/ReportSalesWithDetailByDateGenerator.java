...
public class ReportSalesWithDetailByDateGenerator extends AbstractFVDialog {
   ...
   public ReportSalesWithDetailByDateGenerator(Shell parentShell) {
      super(parentShell);
   }
   ...
   private void initFileName() {
      ...
      dlg.setFileName("Ventas_con_detalle_por_fecha_" + this.createDateToFile());
      String fn = dlg.open();
      if (fn != null) {
         this.setFileName(fn);
      }
   ...
   private void runThread() {
      if (!"".equals(this.getFileName())) {
         (new ReportSalesWithDetailByDateGeneratorInner(this.getShell().getDisplay(), this.progressBar, this.getStartDate(), this.getEndDate(), this.getOrderService(), this.getFileName(), this.lblProgressBarTitle, this.getButton(1), this)).start();
      } else {
         this.close();
      }
