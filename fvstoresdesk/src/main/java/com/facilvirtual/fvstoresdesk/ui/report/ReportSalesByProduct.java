...
public class ReportSalesByProduct extends AbstractFVDialog {
   ...
   public ReportSalesByProduct(Shell parentShell) {
      super(parentShell);
   }
   ...
   @Override protected void configureShell(Shell newShell) {
      ...
      this.initTitle(newShell, "Informe de Ventas por artículos");
   }
