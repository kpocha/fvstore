...
public class FacturaAPdfCreator {
   protected static Logger logger = LoggerFactory.getLogger("FacturaCPdfCreator");
   private Order order;
   private String fileName;
   private Shell shell;

   public FacturaAPdfCreator(Order order, Shell shell) {
      this.order = order;
   ...
   public void createPdf() {
      ...
      try {
         ...
         canvas.showTextAligned(0, "A", this.getPoints(101), this.getPoints(276), 0.0F);
         canvas.setFontAndSize(bf, 8.0F);
         canvas.showTextAligned(0, "CÓD. 01", this.getPoints(99.5F), this.getPoints(272), 0.0F);
         canvas.setFontAndSize(bf, 8.0F);
         ...
         canvas.beginText();
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(0, "Razón Social: ", this.getPoints(15), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(0, this.order.getCustomer().getCompanyName(), this.getPoints(38), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(0, "CUIT: ", this.getPoints(110), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         if (this.order.hasAfipCae()) {
            canvas.showTextAligned(0, this.order.getAfipDocNroToPrint(), this.getPoints(120), this.getPoints(posY), 0.0F);
         } else {
         ...
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(0, "Responsable Inscripto", this.getPoints(33), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf2, 9.0F);
         ...
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(0, "Cantidad", this.getPoints(112), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(0, "P. Unitario", this.getPoints(132), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(0, "Alic. IVA", this.getPoints(158), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf2, 9.0F);
         ...
         for(int i = 1; i < 2; ++i) {
            ...
            while(var27.hasNext()) {
               ...
               canvas.showTextAligned(0, orderLine.getDescriptionLine1ToPrint(40), this.getPoints(42), this.getPoints(posY), 0.0F);
               canvas.showTextAligned(2, orderLine.getQtyToPrint(), this.getPoints(128), this.getPoints(posY), 0.0F);
               canvas.showTextAligned(2, orderLine.getNetPriceToPrint(), this.getPoints(153), this.getPoints(posY), 0.0F);
               canvas.showTextAligned(2, orderLine.getVatValueToDisplay(), this.getPoints(173), this.getPoints(posY), 0.0F);
               canvas.showTextAligned(2, orderLine.getNetSubtotalToPrint(), this.getPoints(198), this.getPoints(posY), 0.0F);
               String descLine2 = orderLine.getDescriptionLine2ToPrint(40);
            ...
            try {
               if (this.order.getDiscountSurcharge() != 0.0) {
                  canvas.showTextAligned(0, "Dto./Recargo", this.getPoints(42), this.getPoints(posY), 0.0F);
                  canvas.showTextAligned(2, "21%", this.getPoints(173), this.getPoints(posY), 0.0F);
                  canvas.showTextAligned(2, this.order.getNetoDtoRecargoToPrint(), this.getPoints(198), this.getPoints(posY), 0.0F);
                  posY -= 5;
               }
         ...
         canvas.beginText();
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "Importe Neto Gravado: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.order.getImpNetoToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "IVA 21%: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.order.getImporteIVA21ToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "IVA 10,5%: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.order.getImporteIVA105ToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "Importe Otros Tributos: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, "0,00", this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 10.0F);
