...
public class NotaDeCreditoAPdfCreator {
   protected static Logger logger = LoggerFactory.getLogger("NotaDeCreditoAPdfCreator");
   private NotaDeCredito notaDeCredito;
   private String fileName;
   private Shell shell;

   public NotaDeCreditoAPdfCreator(NotaDeCredito notaDeCredito, Shell shell) {
   ...
   public void createPdf() {
      ...
      try {
         ...
         canvas.showTextAligned(0, "CÓD. 03", this.getPoints(99.5F), this.getPoints(272), 0.0F);
         canvas.setFontAndSize(bf, 8.0F);
         ...
         if (this.notaDeCredito.getCustomer() != null) {
            canvas.setFontAndSize(bf, 9.0F);
            canvas.showTextAligned(0, this.notaDeCredito.getCustomer().getCompanyName(), this.getPoints(38), this.getPoints(posY), 0.0F);
         }
         ...
         if (this.notaDeCredito.hasAfipCae()) {
            canvas.showTextAligned(0, this.notaDeCredito.getAfipDocNroToPrint(), this.getPoints(120), this.getPoints(posY), 0.0F);
         } else if (this.notaDeCredito.getCustomer() != null) {
         ...
         canvas.showTextAligned(0, this.notaDeCredito.getProductDescriptionLine1ToPrint(40), this.getPoints(42), this.getPoints(posY), 0.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getProductQtyToPrint(), this.getPoints(128), this.getPoints(posY), 0.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getProductNetPriceToPrint(), this.getPoints(153), this.getPoints(posY), 0.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getVatValueToDisplay(), this.getPoints(173), this.getPoints(posY), 0.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getProductNetSubtotalToPrint(), this.getPoints(198), this.getPoints(posY), 0.0F);
         ...
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getImpNetoToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "IVA 21%: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getImporteIVA21ToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
         canvas.showTextAligned(2, "IVA 10,5%: $", this.getPoints(165), this.getPoints(posY), 0.0F);
         canvas.setFontAndSize(bf, 9.0F);
         canvas.showTextAligned(2, this.notaDeCredito.getImporteIVA105ToPrint(), this.getPoints(195), this.getPoints(posY), 0.0F);
         posY -= 5;
         canvas.setFontAndSize(bf2, 9.0F);
