...
@Entity
@Table(
   name = "fvpos_vat_condition"
)
public class VatCondition implements Serializable {
   ...
   public VatCondition(String conditionName, String abbreviateName, boolean availableForCompany, boolean availableForCustomer) {
   ...
   public String getNameToPrint() {
      return "Monotributo".equals(this.getName()) ? "Responsable Monotributo" : this.getName();
   }
}
