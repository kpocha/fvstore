...
@Entity
@Table(
   name = "fvpos_customer_on_account_op"
)
public class CustomerOnAccountOperation implements Serializable {
   private static final long serialVersionUID = -1187344324554643236L;
   @Id
   @Column(
      name = "operation_id"
   )
   ...
   public CustomerOnAccountOperation() {
   }
